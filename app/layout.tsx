...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: RESUME_DATA.description,
    creator: '@berkelomang',
    images: [`${RESUME_DATA.personalWebsiteUrl}images/preview.jpg`],
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${geist.variable} ${geistMono.variable} bg-zinc-50 font-[family-name:var(--font-geist)] antialiased dark:bg-zinc-950`}
      >
        <ThemeProvider
          enableSystem={true}
          attribute="class"
