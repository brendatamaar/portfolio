<script lang="ts">
  ...
  // Match old constants/ADMONITION_TYPES exactly
  const ADMONITION_TYPES = [
    'note', 'warning', 'danger', 'tip', 'info', 'tldr', 'update', 'ai', 'see-also',
  ]
...
>
  ...
  <!-- Headings -->
  <button type="button" title="H1" onclick={() => onLinePrefix('# ')} class="{base} {inactive}">
    <Heading1 size={13} />
  </button>
  <button type="button" title="H2" onclick={() => onLinePrefix('## ')} class="{base} {inactive}">
    <Heading2 size={13} />
  </button>
  <button type="button" title="H3" onclick={() => onLinePrefix('### ')} class="{base} {inactive}">
    <Heading3 size={13} />
  </button>
  ...
  <button type="button" title="Image" onclick={onGallery} class="{base} {inactive}">
    <Image size={13} />
  </button>
  ...
  {#if viewMode === 'split'}
    <button
      ...
      class="{base} {syncScroll ? active : inactive}"
  ...
  <button type="button" title="Preview only (Ctrl+Shift+P)" onclick={() => onViewMode('preview')} class="{base} {viewMode === 'preview' ? active : inactive}">
    <Eye size={13} />
  </button>
